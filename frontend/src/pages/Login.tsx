        ...
        <p className="text-center text-white/70 text-xs mt-8 font-medium">
          © 2026 Student Management System. All rights reserved.
                  ...
                  <input
                    ...
                    onChange={(e) => setRegisterData({...registerData, firstName: e.target.value})}
                    placeholder="First name"
                    className="w-full px-3 py-2 rounded-lg bg-white/90 text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
                    required
                  />
                </div>
                <div>
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-2 rounded-lg font-semibold text-sm hover:from-green-600 hover:to-green-700 transition-all duration-300 mt-4"
              >
                Register Now
              </button>
              ...
              <button
                type="button"
                onClick={() => setShowRegister(false)}
                className="w-full text-white underline hover:text-blue-100 transition-colors text-sm"
              >
                Back to Login
              </button>
            </form>
          ...
          {activeTab === 'admin' && (
            <form onSubmit={handleAdminLogin} className="space-y-4">
              ...
              <div className="bg-yellow-400/20 border border-yellow-400/50 rounded-lg p-3 mb-4">
                <p className="text-xs text-yellow-100 mb-2">📋 Demo Credentials (Click Generate for Random):</p>
                <div className="space-y-1 text-sm font-mono text-white">
                  <p>ID: <span className="font-semibold">{adminUser || 'ADMIN1234'}</span></p>
                  <p>Password: <span className="font-semibold">{adminPass || 'demo1234'}</span></p>
                </div>
              </div>
              ...
              <button
                type="button"
                onClick={generateRandomAdmin}
                className="w-full bg-yellow-500/30 hover:bg-yellow-500/40 text-white py-2 rounded-lg font-semibold transition-all duration-300 text-sm mb-4"
              >
                Generate Random Credentials
              </button>

              <div>
                <label className="block text-sm font-medium text-white mb-2">Admin ID</label>
                <input
                  type="text"
                  value={adminUser}
                  onChange={(e) => setAdminUser(e.target.value)}
                  placeholder="Enter admin ID"
                  className="w-full px-4 py-3 rounded-lg bg-white/90 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-400"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-purple-500 to-purple-600 text-white py-3 rounded-lg font-semibold hover:from-purple-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center gap-2"
              >
                <LogIn size={20} />
                Admin Sign In
              </button>
